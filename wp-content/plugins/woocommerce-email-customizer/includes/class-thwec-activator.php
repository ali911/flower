...
class THWEC_Activator {
	...
	/**
	 * Upload directory for email customizer
	 */
	...
	/**
	 * Prepare and update plugin settings
	 */
	...
	/**
	 * Check for missing data in settings if any (not for first time install)
	 *
	 * @param array $premium premium version settings
	 * @return array $premium updated settings
	 */
